...
endpoints = {"pub": "neat", "sub1": "swell", "sub2": "this"}
...
commands = {"pub": "timeout 15s python3 /home/seena/globus-stream/zmq/src/multi-port.v.04/main.py --publish --num_subs 1 --num_conns 2",
